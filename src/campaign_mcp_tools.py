...
class CampaignMCPTools:
    ...
    async def expand_campaign_indicators(
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Campaign indicator expansion failed: {str(e)}",
                "expanded_indicators": None
            }
    ...
    async def get_campaign_timeline(
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Campaign timeline build failed: {str(e)}",
                "timeline": None
            }
    ...
    async def compare_campaigns(
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Campaign comparison failed: {str(e)}",
                "comparison": None
            }
    ...
    async def detect_ongoing_campaigns(
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Ongoing campaign detection failed: {str(e)}",
    ...
    async def search_campaigns(
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Campaign search failed: {str(e)}",
    ...
    async def get_campaign_details(
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Campaign details retrieval failed: {str(e)}",
                "campaign_details": None
            }
