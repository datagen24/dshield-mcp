...
class TestAPIKeyGenerator:
    ...
    def test_init_custom_values(self) -> None:
        ...
        generator = APIKeyGenerator(default_length=64, default_charset="abc123", salt_length=32)
    ...
    def test_generate_key_with_metadata_no_expiration(self) -> None:
        ...
        result = generator.generate_key_with_metadata(
            name="Test Key", permissions={"read_tools": True}, expiration_days=None
        )
    ...
    def test_generate_key_with_metadata_invalid_expiration(self) -> None:
        ...
        with pytest.raises(ValueError, match="Expiration days must be positive"):
            generator.generate_key_with_metadata(name="Test", permissions={}, expiration_days=0)

        with pytest.raises(ValueError, match="Expiration days must be positive"):
            generator.generate_key_with_metadata(name="Test", permissions={}, expiration_days=-1)
    ...
    def test_generate_key_with_metadata_invalid_rate_limit(self) -> None:
        ...
        with pytest.raises(ValueError, match="Rate limit must be positive"):
            generator.generate_key_with_metadata(name="Test", permissions={}, rate_limit=0)

        with pytest.raises(ValueError, match="Rate limit must be positive"):
            generator.generate_key_with_metadata(name="Test", permissions={}, rate_limit=-1)
    ...
    def test_verify_key_valid(self) -> None:
        ...
        # Verify the key
        is_valid = generator.verify_key(key_value, hash_result["hash"], hash_result["salt"])
    ...
    def test_verify_key_invalid(self) -> None:
        ...
        is_valid = generator.verify_key(wrong_key, hash_result["hash"], hash_result["salt"])
    ...
    def test_verify_key_invalid_salt(self) -> None:
        ...
        is_valid = generator.verify_key(key_value, hash_result["hash"], "invalid_salt")
    ...
    def test_validate_permissions_invalid_key(self) -> None:
        ...
        invalid_permissions = {"read_tools": True, "invalid_key": False}
    ...
    def test_validate_permissions_invalid_rate_limit(self) -> None:
        ...
        invalid_permissions = {"read_tools": True, "rate_limit": "invalid"}

        assert generator.validate_permissions(invalid_permissions) is False

        invalid_permissions = {"read_tools": True, "rate_limit": 0}
    ...
    def test_validate_permissions_invalid_boolean(self) -> None:
        ...
        invalid_permissions = {"read_tools": "invalid", "write_back": 123}
