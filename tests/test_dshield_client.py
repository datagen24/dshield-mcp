...
class TestDShieldClient:
    ...
    def test_init(self, mock_get_config, mock_op_secrets_class, mock_resolve_secrets, mock_user_config):
    ...
    @patch('src.dshield_client.OnePasswordSecrets')
    @patch('src.config_loader.get_config')
    def test_init_with_op_urls(self, mock_get_config, mock_op_secrets_class, mock_resolve_secrets, mock_user_config):
    ...
    @patch('src.dshield_client.OnePasswordSecrets')
    @patch('src.config_loader.get_config')
    def test_init_without_api_key(self, mock_get_config, mock_op_secrets_class, mock_resolve_secrets, mock_user_config):
    ...
    @patch('src.dshield_client.OnePasswordSecrets')
    @patch('src.config_loader.get_config')
    async def test_close(self, mock_get_config, mock_op_secrets_class, mock_resolve_secrets, mock_user_config):
    ...
    @patch('src.dshield_client.OnePasswordSecrets')
    @patch('src.config_loader.get_config')
    async def test_enrich_ips_batch(self, mock_get_config, mock_op_secrets_class, mock_resolve_secrets, mock_user_config):
...
class TestDShieldClientRateLimiting:
    ...
    @patch('src.dshield_client.OnePasswordSecrets')
    @patch('src.config_loader.get_config')
    async def test_rate_limiting(self, mock_get_config, mock_op_secrets_class, mock_resolve_secrets, mock_user_config):
...
class TestDShieldClientCaching:
    ...
    @patch('src.dshield_client.OnePasswordSecrets')
    @patch('src.config_loader.get_config')
    def test_cache_operations(self, mock_get_config, mock_op_secrets_class, mock_resolve_secrets, mock_user_config):
    ...
    @patch('src.dshield_client.OnePasswordSecrets')
    @patch('src.config_loader.get_config')
    def test_cache_expiration(self, mock_get_config, mock_op_secrets_class, mock_resolve_secrets, mock_user_config):
