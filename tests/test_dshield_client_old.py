...
class TestDShieldClient:
    ...
    async def test_connect(self, mock_client_session_class, mock_user_config, mock_op_secrets_class, mock_get_config):
    ...
    @patch('src.dshield_client.get_config')
    @patch('src.dshield_client.aiohttp.ClientSession')
    async def test_get_ip_reputation_success(self, mock_client_session_class, mock_user_config, mock_op_secrets_class, mock_get_config):
    ...
    @patch('src.dshield_client.get_config')
    @patch('src.dshield_client.aiohttp.ClientSession')
    async def test_get_ip_reputation_not_found(self, mock_client_session_class, mock_user_config, mock_op_secrets_class, mock_get_config):
    ...
    @patch('src.dshield_client.get_config')
    @patch('src.dshield_client.aiohttp.ClientSession')
    async def test_get_ip_reputation_cached(self, mock_client_session_class, mock_user_config, mock_op_secrets_class, mock_get_config):
    ...
    @patch('src.dshield_client.get_config')
    @patch('src.dshield_client.aiohttp.ClientSession')
    async def test_get_ip_reputation_http_error(self, mock_client_session_class, mock_user_config, mock_op_secrets_class, mock_get_config):
    ...
    @patch('src.dshield_client.get_config')
    @patch('src.dshield_client.aiohttp.ClientSession')
    async def test_get_top_attackers(self, mock_client_session_class, mock_user_config, mock_op_secrets_class, mock_get_config):
    ...
    @patch('src.dshield_client.get_config')
    @patch('src.dshield_client.aiohttp.ClientSession')
    async def test_get_attack_summary(self, mock_client_session_class, mock_user_config, mock_op_secrets_class, mock_get_config):
    ...
    async def test_enrich_ips_batch(self, mock_get_config, mock_op_secrets_class, mock_user_config):
        ...
        client.get_ip_reputation = AsyncMock(side_effect=[
...
class TestDShieldClientErrorHandling:
    ...
    @patch('src.dshield_client.OnePasswordSecrets')
    @patch('src.dshield_client.get_user_config')
    async def test_get_ip_reputation_with_error_handler_general_error(self, mock_get_config, mock_op_secrets_class, mock_user_config):
    ...
    @patch('src.dshield_client.OnePasswordSecrets')
    @patch('src.dshield_client.get_user_config')
    async def test_get_ip_reputation_without_error_handler_raises_exception(self, mock_get_config, mock_op_secrets_class, mock_user_config):
    ...
    @patch('src.dshield_client.OnePasswordSecrets')
    @patch('src.dshield_client.get_user_config')
    async def test_get_ip_details_with_error_handler(self, mock_get_config, mock_op_secrets_class, mock_user_config):
    ...
    @patch('src.dshield_client.OnePasswordSecrets')
    @patch('src.dshield_client.get_user_config')
    async def test_get_top_attackers_with_error_handler(self, mock_get_config, mock_op_secrets_class, mock_user_config):
    ...
    @patch('src.dshield_client.OnePasswordSecrets')
    @patch('src.dshield_client.get_user_config')
    async def test_get_attack_summary_with_error_handler(self, mock_get_config, mock_op_secrets_class, mock_user_config):
