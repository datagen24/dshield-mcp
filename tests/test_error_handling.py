...
class TestErrorHandlingConfig:
    ...
    def test_custom_configuration(self) -> None:
        ...
        custom_timeouts = {
            "elasticsearch_operations": 60.0,
            "dshield_api_calls": 20.0
        }
...
class TestMCPErrorHandler:
    ...
    def test_create_external_service_error(self) -> None:
        ...
        error = error_handler.create_external_service_error(
            "Elasticsearch",
            "Connection refused"
        )
