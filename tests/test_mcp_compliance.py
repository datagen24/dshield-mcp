...
class TestErrorHandlingCompliance:
    ...
    async def test_external_service_error_handling(self):
        ...
        service_error = error_handler.create_external_service_error(
            "test_service", "Service unavailable"
        )
    ...
    async def test_resource_error_handling(self):
        ...
        resource_error = error_handler.create_resource_error(
            "test://resource", "not_found", "Resource not found"
        )
...
class TestMCPResourceCompliance:
    ...
    async def test_resource_listing(self):
        ...
        resources = server.server.get_capabilities(
            notification_options=MagicMock(), experimental_capabilities={}
        ).resources
