...
class TestPhase3ErrorHandlingFeatures:
    ...
    def test_enhanced_resource_error_methods(self) -> None:
        ...
        error = error_handler.create_resource_access_denied_error(
    ...
    def test_validation_error_with_context(self) -> None:
        ...
        error = error_handler.create_validation_error_with_context(
            "test_tool", mock_validation_error, context
        )
    ...
    def test_timeout_error_with_context(self) -> None:
        ...
        error = error_handler.create_timeout_error_with_context(
            "test_tool", 30.0, operation_context
        )
