...
class TestDShieldCircuitBreakerIntegration:
    ...
    def dshield_client(self, error_handler: MCPErrorHandler) -> DShieldClient:
        ...
        with patch('src.dshield_client.get_config') as mock_get_config, \
    ...
    def test_circuit_breaker_check_allows_execution_when_closed(self, dshield_client: DShieldClient) -> None:
        """Test that circuit breaker allows execution when closed."""
        result = dshield_client._check_circuit_breaker("test_operation")
        assert result is True
    
    def test_circuit_breaker_check_blocks_execution_when_open(self, dshield_client: DShieldClient) -> None:
...
class TestDShieldCircuitBreakerInOperations:
    ...
    @pytest.mark.asyncio
    async def test_get_ip_reputation_with_circuit_breaker_closed(self, dshield_client: DShieldClient) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_ip_reputation_with_circuit_breaker_open(self, dshield_client: DShieldClient) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_ip_details_with_circuit_breaker_closed(self, dshield_client: DShieldClient) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_ip_details_with_circuit_breaker_open(self, dshield_client: DShieldClient) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_top_attackers_with_circuit_breaker_closed(self, dshield_client: DShieldClient) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_top_attackers_with_circuit_breaker_open(self, dshield_client: DShieldClient) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_attack_summary_with_circuit_breaker_closed(self, dshield_client: DShieldClient) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_attack_summary_with_circuit_breaker_open(self, dshield_client: DShieldClient) -> None:
...
class TestDShieldCircuitBreakerRecovery:
    ...
    def test_circuit_breaker_recovery_timeout(self, dshield_client: DShieldClient) -> None:
        ...
        dshield_client.circuit_breaker.last_failure_time = datetime.now(timezone.utc) - timedelta(seconds=70)
